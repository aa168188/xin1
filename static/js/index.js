...
$(function(){
  ...
  var pageNameID = pathNameArr[pathNameArr.length-1].split('.')[0].substring(1);
  // 如果包含'-'，只取'-'前面的数字部分，并转为number类型
  pageNameID = pageNameID.includes('-') ? Number(pageNameID.split('-')[0]) : Number(pageNameID);
  ...
  })(window, document, "script", "_qha", 615295, false);
